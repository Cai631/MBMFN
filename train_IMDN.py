...
parser.add_argument("--root", type=str, default="/home/cai1075/ChengXu2/MB_light/",
...
model = architecture.IMDN(upscale=args.scale)                  #   修改成IMDN
...
if cuda:
    ...
    l1_criterion = l1_criterion.to(device)                     # xiugai
